...
void main(){
	...
	blur += texture(blurMapSampler, UV + vec2(-5.0*scaleUniform.x, -5.0*scaleUniform.y)).rgb * 0.0093;
	blur += texture(blurMapSampler, UV + vec2(-4.0*scaleUniform.x, -4.0*scaleUniform.y)).rgb * 0.028002;
...
//	vec3 blur = vec3(0.0);
//		
//	blur += texture(shadowMapSampler, UV + vec2(-3.0*scaleUniform.x, -3.0*scaleUniform.y)).rgb * 0.015625;
//	blur += texture(shadowMapSampler, UV + vec2(-2.0*scaleUniform.x, -2.0*scaleUniform.y)).rgb * 0.09375;
//	blur += texture(shadowMapSampler, UV + vec2(-1.0*scaleUniform.x, -1.0*scaleUniform.y)).rgb * 0.234375;
