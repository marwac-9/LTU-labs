...
void main()
{
	...
	color = vec4((lightColor * lightPower * (MaterialDiffuseColor * ambient + (MaterialDiffuseColor * Diffuse + SpecularColor * Specular * glossiness) * visibility) * attenuation), 1.0);
